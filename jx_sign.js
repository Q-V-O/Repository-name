...
[task_local]
#京喜签到
5 0 * * * https://raw.githubusercontent.com/wuzhi1/MyActions/main/scripts/jx_sign.js, tag=京喜签到, enabled=true

================Loon==============
[Script]
cron "5 0 * * *" script-path=https://raw.githubusercontent.com/wuzhi1/MyActions/main/scripts/jx_sign.js,tag=京喜签到

===============Surge=================
京喜签到 = type=cron,cronexp="5 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/wuzhi1/MyActions/main/scripts/jx_sign.js

============小火箭=========
京喜签到 = type=cron,script-path=https://raw.githubusercontent.com/wuzhi1/MyActions/main/scripts/jx_sign.js, cronexpr="5 0 * * *", timeout=200, enable=true
 */
const $ = new Env('京喜签到');
