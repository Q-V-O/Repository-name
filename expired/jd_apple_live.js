...
[task_local]
#苹果抽奖机
10 0 * * * https://raw.githubusercontent.com/wuzhi01/MyActions/main/scripts/jd_apple_live.js, tag=苹果抽奖机, enabled=true

================Loon==============
[Script]
cron "10 0 * * *" script-path=https://raw.githubusercontent.com/wuzhi01/MyActions/main/scripts/jd_apple_live.js,tag=苹果抽奖机

===============Surge=================
苹果抽奖机 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/wuzhi01/MyActions/main/scripts/jd_apple_live.js

============小火箭=========
苹果抽奖机 = type=cron,script-path=https://raw.githubusercontent.com/wuzhi01/MyActions/main/scripts/jd_apple_live.js, cronexpr="10 0 * * *", timeout=200, enable=true
 */
const $ = new Env('苹果抽奖机');
